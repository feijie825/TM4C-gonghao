...
//*****************************************************************************
//
// Define an assembler symbol for the CANBOOT starting address.
//
//*****************************************************************************
_CANBOOT_START_ADDRESS          equ     CANBOOT_START_ADDRESS

//*****************************************************************************
//
// Define an assembler symbol for the CANBOOT vector table address.
//
//*****************************************************************************
_CANBOOT_VTABLE_START_ADDRESS   equ     CANBOOT_VTABLE_START_ADDRESS

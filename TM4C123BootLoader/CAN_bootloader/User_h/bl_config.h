...
//
//*****************************************************************************
#define APP_START_ADDRESS       0x0010000

#define CANBOOT_START_ADDRESS   0x2000          //CAN引导程序起始地址
//*****************************************************************************
//
...
//
//*****************************************************************************
#define VTABLE_START_ADDRESS            0x0010000

#define CANBOOT_VTABLE_START_ADDRESS    0x004000
...
// Exclusive of: None
// Requires: None
// FLASH 保留空间  预留1K空间 作为永久数据区 存放需固化的参数
//*****************************************************************************
...
//
//*****************************************************************************
//#define ENABLE_UPDATE_CHECK      //使能更新检查
...
#define BOARD_ID_PERIPH         SYSCTL_RCGC2_GPIOG	 //表位号端口
//*****************************************************************************
//
...
//
//*****************************************************************************
#define FORCED_UPDATE_PORT      GPIO_PORTE_BASE            //ZLZ2014.08.18改为PE.5 小显示KEYIN口
#define BOARD_ID_PORT           GPIO_PORTG_BASE            //板号ID
...
//
//*****************************************************************************
#define CAN_RX_PERIPH           SYSCTL_RCGC2_GPIOB//SYSCTL_RCGC2_GPIOA
...
//
//*****************************************************************************
#define CAN_RX_PORT             GPIO_PORTB_BASE //GPIO_PORTA_BASE
...
//
//*****************************************************************************
#define CAN_TX_PERIPH           SYSCTL_RCGC2_GPIOB//SYSCTL_RCGC2_GPIOA
...
//
//*****************************************************************************
#define CAN_TX_PORT             GPIO_PORTB_BASE //GPIO_PORTA_BASE

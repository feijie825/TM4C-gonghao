...
#define BGB_C_GPIO            GPIOF    //三相续流继电器闭合控制
#define GBA_C_GPIO            GPIOF    //A相续流继电器断开控制
#define GBB_C_GPIO            GPIOF    //B相续流继电器断开控制 
...
//PORTJ
#define MC_OUT1_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出1
#define MC_OUT2_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出2
#define MC_OUT3_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出3
#define MC_OUT4_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出4
#define MC_OUT5_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出5
#define MC_OUT6_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出6
#define MC_OUT7_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出7
#define MC_OUT8_GPIO          GPIOJ    //专变终端Ⅲ型(2013版)脉冲输出8
...
//PORTN
#define TTAB1                 GPIO_PIN_0   //双回路切换1
#define TTAB2                 GPIO_PIN_1   //双回路切换2
...
//PORTF                       
#define UC_ESW_ON             GPIOPinWrite(UC_ESWC_GPIO,UC_ESWC,0)         //C相电压电子开关接入
#define UC_ESW_OFF            GPIOPinWrite(UC_ESWC_GPIO,UC_ESWC,UC_ESWC)   //C相电压电子开关断开
#define UB_ESW_ON             GPIOPinWrite(UB_ESWC_GPIO,UB_ESWC,0)         //B相电压电子开关接入
#define UB_ESW_OFF            GPIOPinWrite(UB_ESWC_GPIO,UB_ESWC,UB_ESWC)   //B相电压电子开关断开
#define UA_ESW_ON             GPIOPinWrite(UA_ESWC_GPIO,UA_ESWC,0)         //A相电压电子开关接入
#define UA_ESW_OFF            GPIOPinWrite(UA_ESWC_GPIO,UA_ESWC,UA_ESWC)   //A相电压电子开关断开
...
#define IBJDQ_OPEN_CANCEL     GPIOPinWrite(GBB_C_GPIO,GBB_C,0)             //B相续流继电器断开控制撤销
#define OPEN_IN_STS           GPIOPinRead(OPEN_IN_GPIO,OPEN_IN)            //开路信号输入状态
